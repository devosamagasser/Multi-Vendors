                                    ...
                                    <ul class="shopping-list">
                                        <li>
                                            ...
                                            <div class="cart-img-head">
                                                <a class="cart-img" href="product-details.html"><img src="{{asset('assets/assets/images/header/cart-items/item1.jpg')}}"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <li>
                                            <a href="javascript:void(0)" class="remove" title="Remove this item"><i class="lni lni-close"></i></a>
                                            <div class="cart-img-head">
                                                <a class="cart-img" href="product-details.html"><img src="{{asset('assets/assets/images/header/cart-items/item2.jpg')}}"></a>
                                            </div>
                                            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="footer-logo">
                            <a href="index-2.html">
                                <img src="{{asset('assets/assets/images/logo/white-logo.svg')}}">
                            </a>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-4 col-12">
                        <div class="payment-gateway">
                            <span>We Accept:</span>
                            <img src="{{asset('assets/assets/images/footer/credit-cards-footer.png')}}">
                        </div>
                    </div>
                    <div class="col-lg-4 col-12">
                        <div class="copyright">
